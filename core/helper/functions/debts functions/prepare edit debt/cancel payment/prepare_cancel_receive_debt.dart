...
Map prepareCancelReceiveDebt(
  ...
  var transactionsDescription =
      "إلغاء استلام مبلغ ${Formatter.formatAmount(amount, currencyId: debtPaymentInputModel.debtPaymentsAmountCurrencyId)} من  ${debtPaymentInputModel.clientsName ?? debtPaymentInputModel.personName}";
  //$ exchange
