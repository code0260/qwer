...
Map prepareEditTheft(EditProductCountModel editProductCountModel) {
  Map data = {};
  data["product_place_details"] = editProductCountModel.toMap();

  // transaction
  List<TransactionLineInputModel> lines = [];
  var transactionsDescription = "تعديل كمية منتج بسبب سرقة";
  //$ Credit
  int accountsIdForTheftExpense =
      StoreAccounts.getAccountByCode('329007')!.accountsId!;
