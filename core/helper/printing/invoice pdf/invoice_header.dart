...
Widget buildInvoiceHeader(Image? logo, GetInvoicesItemsModel invoicesItems) {
  return Column(
    ...
    children: [
      ...
      Divider(thickness: 0.7, color: PdfColors.grey),
      SizedBox(height: 4),
    ],
  );
}
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 4),
        Flexible(child: Text(value, style: const TextStyle(fontSize: 9))),
      ],
    ),
  );
}
