...
class EditBuyUnitCubit extends SafeCubit<EditUnitModel> {
  EditBuyUnitCubit() : super(EditUnitModel());

  void editBuyUnit(int productsId, String unitName, String unitSymbol,
    ...
    int unitId = units[unitGroup]!
        ...
        .unitsId!;
    cartBuyHome[index].batchModel.batchesCountUnitId = unitId;
    cartBuyHome[index].batchModel.unitsSymbol = unitSymbol;
    var conversion = (unitConversionFactor /
            (cartBuyHome[index].productModel.unitsBaseConversion ?? 1))
        .roundToNearest(-3);
    cartBuyHome[index].batchModel.unitsConversionFactor = conversion;
